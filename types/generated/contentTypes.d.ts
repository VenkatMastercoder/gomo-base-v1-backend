...
export interface ApiBrandrequestBrandrequest extends Schema.CollectionType {
  collectionName: 'brandrequests';
  info: {
...
export interface ApiInfluencerrequestInfluencerrequest
  extends Schema.CollectionType {
